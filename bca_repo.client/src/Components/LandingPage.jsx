...
//               To unlock full access, including downloading and publishing study
//               materials, and to enjoy a seamless user experience, please
//               register and log in.
//             </p>
...
//       {/* Hero Section */}
//       <div className="bg-gray-100 min-h-screen w-[100%] flex flex-col items-center p-6 ">
//         <div className="w-full max-w-6xl text-center ">
//           <h1 className="text-5xl font-extrabold text-blue-600 mb-4">
//             Welcome to BCA Repository
//           </h1>
//           <p className="text-xl text-gray-700 mb-8">
//             Your Ultimate Study Companion! A one-stop platform for BCA students
//             to access and share study materials.
//           </p>
//         </div>

//         {/* Content Sections */}
//         <div className="w-full max-w-6xl px-4 space-y-8">
//   <SectionBox title="📚 What We Offer?">
...
//       <li>
//         <strong>Browse & Download</strong> – Access a vast collection of
//         study materials.
//       </li>
//       <li>
//         <strong>Upload & Share</strong> – Contribute your own notes and
//         help others.
//       </li>
//       <li>
//         <strong>Admin Approval</strong> – Uploaded materials are
//         verified for quality.
//       </li>
//       <li>
//         <strong>Easy Access</strong> – Use categories, search, and
//         filters to find resources.
//       </li>
//     </ol>
//   </SectionBox>

//   <SectionBox title="🎯 Why Choose BCA Repository?">
//     <ul className="list-disc pl-6 text-gray-700 mt-4 space-y-2">
//       <li>
//         <strong>Free & Open Access</strong> – Materials are freely
//         available for students.
//       </li>
//       <li>
//         <strong>Well-Organized Categories</strong> – Find notes based on
//         subjects and semesters.
//       </li>
//       <li>
//         <strong>Secure & Verified Content</strong> – Admin approval
//         ensures reliable resources.
//       </li>
//       <li>
...
// </div>
{/* Features Section */ }
// <div className="w-full max-w-6xl bg-white rounded-lg p-8 shadow-lg mt-12">
//   <h2 className="text-3xl font-semibold text-blue-600 border-b pb-2 text-center">
//     ✨ Features
//   </h2>
...
//             🌟 Start Exploring Now! Enhance your learning experience with the
//             best study materials.
//           </p>
//           <p className="text-lg text-blue-600 font-medium mt-2">
//             📥 Have study materials to share? Upload them and help the community
//             grow!
//           </p>
//         </div>
//       </div>
...
//         <p className="text-lg">&copy; 2025 BCA Repository. All rights reserved.</p>
//         <p className="text-sm">
//           Designed to help BCA students with quality study materials.
//         </p>
//       </footer>
//     </>
//   );
...
//     <h2 className="text-3xl font-semibold text-blue-500">{title}</h2>
//     {children}
//   </div>
// );
...
// const FeatureItem = ({ icon, title, description }) => (
//   <div className="flex items-start space-x-4 bg-gray-100 p-4 rounded-lg shadow-md">
//     <div className="flex-shrink-0">{icon}</div>
//     <div>
//       <h3 className="text-lg font-bold">{title}</h3>
//       <p className="text-gray-700">{description}</p>
