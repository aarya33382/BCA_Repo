...
const SingleResource = () => {
    ...
    return (
        <div className="main-container w-screen h-full flex  br">
            ...
            {/* <div className="right w-[50%] h-full bb  flex flex-col overflow-auto ">

                <h1 className="font-bold text-4xl text-gray-700 border rounded  text-center">Related Resources</h1> <br />
                <div className="by w-[80%] h-full">
                    {
                        files.length > 0 ? (
                            // console.log('Working')
                            files.map((file) => {
                                return (
                                    <Link
                                        ...
                                        className=" border rounded-lg shadow-lg p-2 flex flex-col items-center" //bg-white cursor-pointer hover:shadow-xl transition"
                                    >
                                        <div className="flex  justify-between br w-full">

                                            <div className="bg-gray-200 w-[12%] bg h-16 flex items-center justify-center rounded-full text-gray-700 text-lg font-bold">
                                                📄
                                            </div>
                                            <div>
